...
entity txtgen_screen is
    port (
        clk       : in     std_logic ;
        count_v   : in     std_logic_vector(9 downto 0) ;
        count_h   : in     std_logic_vector(9 downto 0) ;
        mode      : in     std_logic ;						    -- '0' for Game Over | '1' for Level Cleared
...
architecture arc_txtgen_screen of txtgen_screen is
...
begin
    ...
    process (int_poschr_h, int_poschr_v, mode, size)
    begin
        if mode = '0' then 
			if size = '0' then
				case conv_integer(int_poschr_v) is
					when 6 => -- line 6
						case conv_integer(int_poschr_h) is
							when 0  => int_char_code <= "011011" ; -- R
							when 1  => int_char_code <= "001110" ; -- E
							when 2  => int_char_code <= "011100" ; -- S
							when 3  => int_char_code <= "011101" ; -- T
							when 4  => int_char_code <= "001010" ; -- A
							when 5  => int_char_code <= "011011" ; -- R
							when 6  => int_char_code <= "011101" ; -- T
							when 7  => int_char_code <= "110000" ; -- space
							when 8  => int_char_code <= "011100" ; -- S
							when 9  => int_char_code <= "011101" ; -- T
							when 10 => int_char_code <= "001010" ; -- A
							when 11 => int_char_code <= "010000" ; -- G
							when 12 => int_char_code <= "001110" ; -- E
							
							when 24 => int_char_code <= "010110" ; -- M
							when 25 => int_char_code <= "001110" ; -- E
							when 26 => int_char_code <= "010111" ; -- N
							when 27 => int_char_code <= "011110" ; -- U
				...
				case conv_integer(int_poschr_v) is
					when 0 => -- line 0
						case conv_integer(int_poschr_h) is
							when 5  => int_char_code <= "010000" ; -- G
							when 6  => int_char_code <= "001010" ; -- A
							when 7  => int_char_code <= "010110" ; -- M
							when 8  => int_char_code <= "001110" ; -- E
							when 9  => int_char_code <= "110000" ; -- space
							when 10 => int_char_code <= "011000" ; -- O
							when 11 => int_char_code <= "011111" ; -- V
							when 12 => int_char_code <= "001110" ; -- E
							when 13 => int_char_code <= "011011" ; -- R
							when others => int_char_code <= "110000" ; -- space
						end case ;
					when others => int_char_code <= "110000" ; -- space
				end case ;
			...
			if size = '0' then
				case conv_integer(int_poschr_v) is
					when 6 => -- line 6
						case conv_integer(int_poschr_h) is
							when 1  => int_char_code <= "010111" ; -- N
							when 2  => int_char_code <= "001110" ; -- E
							when 3  => int_char_code <= "100001" ; -- X
							when 4  => int_char_code <= "011101" ; -- T
							when 5  => int_char_code <= "110000" ; -- space
							when 6  => int_char_code <= "011100" ; -- S
							when 7  => int_char_code <= "011101" ; -- T
							when 8  => int_char_code <= "001010" ; -- A
							when 9  => int_char_code <= "010000" ; -- G
							when 10 => int_char_code <= "001110" ; -- E
				...
				case conv_integer(int_poschr_v) is
					when 0 => -- line 0
						case conv_integer(int_poschr_h) is
							when 3  => int_char_code <= "011100" ; -- S
							when 4  => int_char_code <= "011101" ; -- T
							when 5  => int_char_code <= "001010" ; -- A
							when 6  => int_char_code <= "010000" ; -- G
							when 7  => int_char_code <= "001110" ; -- E
							when 8  => int_char_code <= "110000" ; -- space
							when 9  => int_char_code <= "001100" ; -- C
							when 10 => int_char_code <= "010101" ; -- L
							when 11 => int_char_code <= "001110" ; -- E
							when 12 => int_char_code <= "001010" ; -- A
							when 13 => int_char_code <= "011011" ; -- R
							when 14 => int_char_code <= "001110" ; -- E
							when 15 => int_char_code <= "001101" ; -- D
							when others => int_char_code <= "110000" ; -- space
						end case ;
					when others => int_char_code <= "110000" ; -- space
				end case ;
